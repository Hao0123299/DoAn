...
import com.nguyenmanhhao.qlhv.view.HocVienJPanel;
import com.nguyenmanhhao.qlhv.view.ThongKeJPanel;
import com.nguyenmanhhao.qlhv.view.TrangChuJPanel;
    ...
    private void setChangeBackgroud(String kind){
        for(DanhMucBean itemBean: listItem){
            if(itemBean.getKind().equalsIgnoreCase(kind)){
                itemBean.getJpn().setBackground(new Color(96, 101, 191));
                itemBean.getJlb().setBackground(new Color(96, 101, 191));
            }else{
